        ...
        <div class="mb-12 mt-0 md:mt-6 bg-gray-50">
            ...
            <div class="w-full flex flex-col space-x-1 lg:flex-row flex-wrap bg-white lg:flex-nowrap px-4 py-4">
                ...
                <div>
                    ...
                    <h1 class="text-lg  md:text-4xl font-serif font-bold mb-4">Imo-politics</h1>

                    <div class="w-fixed w-full flex-shrink flex-grow-0 border border-gray-200">

                        <!-- FIRST DIV SECTION  -->
                        <div
                            class="w-full grid grid-cols-1 gap-6 md:gap-4 mb-12">
                    ...
                    <div class="grid grid-cols-1 gap-2">
                        ...
                        <div >
                            ...
                            <a href="blog/{{ $render->id }}{{ $render->categories }}"
                                ...
                                <div class="md:mt-2">
                                    <img src="/uploads/{{$render->image}}"
                                         class="w-96  h-36 object-cover" />
                                </div>
