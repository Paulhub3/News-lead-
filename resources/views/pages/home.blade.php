<x-guest-layout>
    ...
    <div class="mb-12 mt-0 md:mt-6">
            ...
            <div class="w-fixed w-full lg:w-5/12 flex-shrink flex-grow-0 px-4 mt-12 lg:mt-o">
                ...
                <div class="p-4 bg-white border border-gray-200 w-full">
                    ...
                    <div
                        ...
                        <a href="blog/{{ $exclusiveNew->id }}{{$exclusiveNew->categories}}"
                            class="grid grid-cols-2 overflow-hidden gap-2 border-y border-y-gray-200 py-4 mb-6">
                            <div class="">
                                <img src="/uploads/{{$exclusiveNew->image}}" loading="lazy"
                                    class="w-full md:w-56 h-36 object-cover" />
                            </div>
                ...
                <div class="grid grid-cols-1 gap-8 md:gap-7 md:grid md:grid-cols-2  mb-12">
                    ...
                    <div class="grid grid-cols-1 gap-5 px-4">
                        ...
                        <a href="blog/{{ $show->id }}{{$show->categories}}">
                            ...
                            <div>
                                <h4
                                    class="text-[rgba(0,51,102,.99)] font-sans text-sm text-justify font-bold hover:underline">
                                    {{$show->title}}
                                </h4>
                            </div>
                        </a>
        ...
        <div>
            <div class=" bg-white border w-96 md:w-full lg:w-72 grid grid-cols-1 gap-4 mt-12 border-gray-200 mb-6 py-3
                px-2">
